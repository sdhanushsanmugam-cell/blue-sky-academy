...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LumenEd — Modern learning for curious minds" },
      { name: "description", content: "Online courses, expert teachers and a student-first learning experience." },
      { name: "author", content: "LumenEd" },
      { property: "og:title", content: "LumenEd — Modern learning for curious minds" },
